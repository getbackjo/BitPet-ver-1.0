...
void petSetup() {
  ...
  if (stage == 1) { // Welcome Screen
    ...
    Tft.drawString("Welcome!", 40, 80, 3, WHITE);
    Tft.drawString("BitPet ver 1.0", 40, 140, 2, WHITE);
    Tft.drawString("Offline Mode", 40, 170, 2, WHITE);
    Tft.drawString("Tap to begin", 40, 230, 2, WHITE);

  }
  else if (stage == 2) { // Question 1
    Tft.drawString("Q1.", 20, 20, 3, WHITE);
    Tft.drawString("Feed your BitPet", 20, 70, 2, WHITE);
    Tft.drawString("with a word", 20, 100, 2, WHITE);
    Tft.drawString("a) Crime", 20, 150, 2, WHITE);
    Tft.drawString("b) Risky", 20, 200, 2, WHITE);
    Tft.drawString("c) Useless", 20, 250, 2, WHITE);
  }
  else if (stage == 3) {  // Question 2
    Tft.drawString("Q2.", 20, 20, 3, WHITE);
    Tft.drawString("Feed your BitPet", 20, 70, 2, WHITE);
    Tft.drawString("with another word", 20, 100, 2, WHITE);
    Tft.drawString("a) Trust", 20, 150, 2, WHITE);
    Tft.drawString("b) Safe", 20, 200, 2, WHITE);
    Tft.drawString("c) Useful", 20, 250, 2, WHITE);
  }
    ...
    petIdle();
    Tft.drawString("i", 30, 260, 3, WHITE);
    Tft.drawString("t", 110, 260, 3, WHITE);
    Tft.drawString("?", 190, 260, 3, WHITE);
    Tft.drawHorizontalLine(0, 245, 240, WHITE);
    Tft.drawVerticalLine(70, 245, 100, WHITE);
    Tft.drawVerticalLine(160, 245, 100, WHITE);
    if (stage == 5) {
      if (p.z > __PRESURE) {
    ...
    Tft.drawString("Stats", 20, 20, 3, WHITE);
    Tft.drawString("Size", 20, 70, 2, WHITE);
    Tft.drawNumber(tweets, 20, 90, 2, WHITE);
    Tft.drawString("Evolutions", 20, 130, 2, WHITE);
    Tft.drawNumber(evolutions, 20, 150, 2, WHITE);
    Tft.drawString("Type", 20, 200, 2, WHITE);
    if (key > 0) {
      Tft.drawString("Unhealthy", 20, 220, 2, WHITE);
    }
    else if (key <= 0) {
      Tft.drawString("Healthy", 20, 220, 2, WHITE);
    }
  }
  else if (stage == 7) { // Tweets Screen
    Tft.drawString("Tweets", 20, 20, 3, WHITE);
    Tft.drawString("Tweets Fed", 20, 70, 2, WHITE);
    Tft.drawNumber(tweets, 20, 90, 2, WHITE);
    Tft.drawString("Tweets with", 20, 130, 2, WHITE);
    if (CrimeA == true) {
      Tft.drawString("'Crime'", 20, 150, 2, WHITE);
      Tft.drawNumber(tweetsCrime, 20, 170, 2, WHITE);
    }
    else if (RiskyA == true) {
      Tft.drawString("'Risky'", 20, 150, 2, WHITE);
      Tft.drawNumber(tweetsRisky, 20, 170, 2, WHITE);
    }
    else if (UselessA == true) {
      Tft.drawString("'Useless'", 20, 150, 2, WHITE);
      Tft.drawNumber(tweetsUseless, 20, 170, 2, WHITE);
    }
    Tft.drawString("Tweets with", 20, 210, 2, WHITE);
    if (TrustB == true) {
      Tft.drawString("'Trust'", 20, 230, 2, WHITE);
      Tft.drawNumber(tweetsTrust, 20, 250, 2, WHITE);
    }
    else if (SafeB == true) {
      Tft.drawString("'Safe'", 20, 230, 2, WHITE);
      Tft.drawNumber(tweetsSafe, 20, 250, 2, WHITE);
    }
    else if (UsefulB == true) {
      Tft.drawString("'Useful'", 20, 230, 2, WHITE);
      Tft.drawNumber(tweetsUseful, 20, 250, 2, WHITE);
    }
  }

  else if (stage == 8) {  // ? Screen

    Tft.drawString("Restart?", 20, 20, 3, WHITE);
    Tft.drawString("a) Yes", 20, 100, 2, WHITE);
    Tft.drawString("b) No", 20, 150, 2, WHITE);
  }
...
void updateStage() {
  ...
  if (stage == 1 && p.z > __PRESURE) { // Entering Q1
    ...
    if (p.z > __PRESURE) {
      if (p.y > 150 && p.y < 170 && p.x > 20 && p.x < 100) { // Crime
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        CrimeA = true;
      ...
      else if (p.y > 200 && p.y < 230 && p.x > 20 && p.x < 100) { // Risky
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        RiskyA = true;
      ...
      else if (p.y > 250 && p.y < 300 && p.x > 20 && p.x < 100) { // Useless
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        UselessA = true;
    ...
    if (p.z > __PRESURE) {
      if (p.y > 150 && p.y < 170 && p.x > 20 && p.x < 100) { // Trust
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        TrustB = true;
      ...
      else if (p.y > 200 && p.y < 230 && p.x > 20 && p.x < 100) { // Safe
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        SafeB = true;
      ...
      else if (p.y > 250 && p.y < 300 && p.x > 20 && p.x < 100) { // Useful
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        delay(500);
        UsefulB = true;
    ...
    if (p.z > __PRESURE) {
      ...
      else if (p.y > 245 && p.x > 70 && p.x < 160) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 7; // Tweet Screen
      }
      else if (p.y > 245 && p.x > 160) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 8; // ? Screen
      }
    ...
    if (p.z > __PRESURE) {
      if (tweets < 5 && p.y < 180 && p.y > 150 && p.x > 20 && p.x < 80) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 5;
      }
      else if (tweets >= 5 && tweets < 10 && p.y < 180 && p.y > 150 && p.x > 20 && p.x < 80 && evolveA == true) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 10;
      }
      else if (tweets >= 5 && tweets < 10 && p.y < 180 && p.y > 150 && p.x > 20 && p.x < 80 && evolveB == true) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 13;
      }
      else if (tweets >= 10 && p.y < 180 && p.y > 150 && p.x > 20 && p.x < 80 && evolveAA == true) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 12;
      }
      else if (tweets >= 10 && p.y < 180 && p.y > 150 && p.x > 20 && p.x < 80 && evolveBB == true) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        stage = 14;
      }
      else if (p.y > 100 && p.y < 130 && p.x > 20 && p.x < 80) {
        Tft.drawRectangle(0, 0, 400, 400, BLACK);
        Tft.fillRectangle(0, 0, 400, 400, BLACK);
        tweets = 0;
        evolutions = 0;
